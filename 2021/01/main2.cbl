      ...
      *-----------------------------------------------------------------
       ...
       SOLVE.
           MOVE 0 TO WS-COUNT.
           MOVE 1 TO WS-I.
           PERFORM UNTIL WS-I > WS-XS-LEN - 2
      *        ADD    WS-XS(WS-I) WS-XS(WS-I + 1) WS-XS(WS-I + 2)
      *        GIVING WS-SUM
      *        END-ADD
              MOVE FUNCTION SUM(
                 WS-XS(WS-I) WS-XS(WS-I + 1) WS-XS(WS-I + 2)
              ) TO WS-SUM
              DISPLAY
                 'WS-XS(WS-I):' WS-XS(WS-I)
                 'WS-XS(WS-I + 1):' WS-XS(WS-I + 1)
                 'WS-XS(WS-I + 2):' WS-XS(WS-I + 2)
                 'WS-SUM:' WS-SUM
              END-DISPLAY
              IF WS-SUM > WS-PREV
